...
3. Open a [new issue][new-issue] to discuss your changes
...
git remote add upstream https://github.com/paymentsds/mpesa-sdk
```
...
[new-issue]: https://github.com/paymentsds/mpesa-sdk/issues/new
